...
// NSOrderedSet (NSOrderedSetDiffing)

- (id)differenceFromOrderedSet:(id)arg1;
- (id)differenceFromOrderedSet:(id)arg1 withOptions:(unsigned long long)arg2;
- (id)differenceFromOrderedSet:(id)arg1 withOptions:(unsigned long long)arg2 usingEquivalenceTest:(id)arg3;
